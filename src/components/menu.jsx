...
//     //     if (cart.length === 0) return alert("🛒 ກະລຸນາເພີ່ມລາຍການກ່ອນກົດສັ່ງຊື້");
...
//             // **ຂໍ້ຄວາມແຈ້ງເຕືອນພາສາລາວ**
//             alert("✅ ສັ່ງຊື້ສຳເລັດແລ້ວ\n\nກະລຸນາໄປຈ່າຍເງິນທີ່ເຄົ້າເຕີເພື່ອຮັບໃບບິນ");
